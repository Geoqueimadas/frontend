...
const cadastro = () => {
  ...
  <Link href="/">
    ...
    <div className="h-screen flex justify-center items-center px-80  ">
      ...
      {emptyValue && form["name"] == "" ? <span className="text-white text-md block">O campo nome precisa ser preenchido</span>: ""}
      ...
      {emptyValue && form["email"] == "" ? <span className="text-white text-md block">O campo e-mail precisa ser preenchido</span>: ""}
      {!validEmail && form["email"] !== "" ? <span className="text-white text-md block">E-mail inválido</span>: ""}
      ...
      {emptyValue && form["dataNasc"] == "" ? <span className="text-white text-md block">O campo data de nascimento precisa ser preenchido</span>: ""}
      {!validDataNasc && form["dataNasc"] !== "" ? <span className="text-white text-md block">Usuário precisa ter mais de 18 anos</span>: ""}
      </div>
      <div className="flex flex-col w-full">
      <label className="text-white mb-3">CEP: </label>
      <input className="mb-3 rounded-lg p-2 focus:outline-none text-red-main" type='text' name='cep' {...register("cep")} onBlur={checkCEP} placeholder='XXXXX-XXX' />
      {emptyValue && form["cep"] == "" ? <span className="text-white text-md block">O campo cep precisa ser preenchido</span>: ""}
      </div>
      </div>
      ...
      {emptyValue && form["telefone"] == "" ? <span className="text-white text-md block">O campo telefone precisa ser preenchido</span>: ""}
      {!validTelefone && form["telefone"] !== "" ? <span className="text-white text-md block">Telefone inválido</span>: ""}
      </div>
      <div className="flex flex-col w-full">
      ...
      {emptyValue && form["cpf"] == "" ? <span className="text-white text-md block">O campo cpf precisa ser preenchido</span>: ""}
      {!validCPF && form["cpf"] !== "" ? <span className="text-white text-md block">CPF inválido</span>: ""}
      </div>
      </div>
      ...
      {emptyValue && form["senha"] == "" ? <span className="text-white text-md block">O campo senha precisa ser preenchido</span>: ""}
      {form["senha"].length < 6 && form["senha"] !== "" ? <span className="text-white text-md block">Senha precisa ter mais de 6 dígitos</span>: ""}
      ...
      {emptyValue && form["repSenha"] == "" ? <span className="text-white text-md block">O campo repetir senha precisa ser preenchido</span>: ""}
      {form["repSenha"] !== form["senha"] && form["repSenha"] !== "" ? <span className="text-white text-md block">Repetir Senha precisa ser igual a senha</span>: ""}
      {form["repSenha"].length < 6 && form["repSenha"] !== "" ? <span className="text-white text-md block">Senha precisa ter mais de 6 dígitos</span>: ""}
